...
ABI = [
    {
        ...
        "inputs": [{"name": "to", "type": "address"}, {"name": "ref", "type": "string"}],
        "outputs": []
    },
    {
        "name": "mint",
    ...
    {"name": "marketCap", "type": "function", "stateMutability": "view", "inputs": [], "outputs": [{"type": "uint256"}]},
    {"name": "circulatingMarketCap", "type": "function", "stateMutability": "view", "inputs": [], "outputs": [{"type": "uint256"}]},
    {"name": "balanceOfUSD", "type": "function", "stateMutability": "view", "inputs": [{"name": "account", "type": "address"}], "outputs": [{"type": "uint256"}]},
    {"name": "setUsdPrice", "type": "function", "stateMutability": "nonpayable", "inputs": [{"name": "newPrice", "type": "uint256"}], "outputs": []}
]
